 ...
 */
export const fetchUploadedFilesR2 = fetchOptimized('fetchUploadedFilesR2', {
	table: TABLE,
	args: {
...
/**
 * Owner-only bulk delete for `uploadedFilesR2`, with R2 cleanup wired through `runStorageDelete`.
 */
