// UTILS
import { translateFromBackend, type TranslatableMessage } from '@/shared/utils/translateFromBackend';
 ...
 *
 * - `rateLimitMessage(retryAfterMs?)` ΓÇö localized UI copy (toasts, inline errors).
 * - `rateLimitMessage(rawError, fallback)` ΓÇö localized copy; parses JSON from auth errors.
 *
