...
<Card class="gap-4 rounded-lg border-destructive/40 p-0 py-4 shadow-sm">
	<CardContent class="flex flex-col gap-4 p-4">
		...
		<UserDangerZoneItem
			title={m['AdminUserPage.UserDangerZone.deleteRowTitle']()}
			description={m['AdminUserPage.UserDangerZone.deleteRowDescription']()}
		>
			<DeleteUserDialog
				userId={user._id}
