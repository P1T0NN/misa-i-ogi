...
<Card class="py-0">
	<CardHeader>
		<CardTitle>Could not load accommodation analytics</CardTitle>
		<CardDescription>Please try again or check back later.</CardDescription>
	</CardHeader>
	<CardContent class="flex flex-col items-center gap-4 py-8 text-center">
		...
		<p class="max-w-md text-sm text-muted-foreground">
			The accommodations report could not be loaded right now.
		</p>
	</CardContent>
</Card>
