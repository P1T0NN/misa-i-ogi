<script lang="ts">
	...
	const chartConfig = $derived({
		qrScans: {
			label: m['AnalyticsAccommodationDetailPage.UserAnalyticsAccommodationChart.qrScans'](),
			color: 'var(--chart-1)'
		},
		guestActivations: {
		...
		reservations: {
			label: m['AnalyticsAccommodationDetailPage.UserAnalyticsAccommodationChart.reservations'](),
			color: 'var(--chart-3)'
		}
...
<AreaChartInteractive
	...
	config={chartConfig}
	timeRange="30d"
	title={m['AnalyticsAccommodationDetailPage.UserAnalyticsAccommodationChart.title']()}
	description={m['AnalyticsAccommodationDetailPage.UserAnalyticsAccommodationChart.description']()}
	cardClass="py-0"
