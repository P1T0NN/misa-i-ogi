<script lang="ts">
	...
	import ReservationsPendingTabEmpty from '../empty/reservations-pending-tab-empty.svelte';
...
<TabsContent value="pending" class="pt-4">
	<ConvexDataList
		query={api.tables.reservations.queries.fetchPendingReservations.fetchPendingReservations}
	...
	>
		...
		{#snippet empty()}
			<ReservationsPendingTabEmpty {searchQuery} {selectedHospitality} />
		{/snippet}
