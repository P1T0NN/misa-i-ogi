...
<TabsContent value="cancelled" class="pt-4">
	<ConvexDataList
		query={api.tables.reservations.queries.fetchCancelledReservations.fetchCancelledReservations}
	...
	>
		...
		{#snippet empty()}
			<ReservationsCancelledTabEmpty {searchQuery} {selectedHospitality} />
		{/snippet}
