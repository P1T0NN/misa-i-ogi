<script lang="ts">
	...
	import ReservationsPastTabEmpty from '../empty/reservations-past-tab-empty.svelte';
...
<TabsContent value="no_show" class="pt-4">
	<ConvexDataList
		query={api.tables.reservations.queries.fetchNoShowReservations.fetchNoShowReservations}
	...
	>
		...
		{#snippet empty()}
			<ReservationsPastTabEmpty {searchQuery} {selectedHospitality} />
		{/snippet}
